...
add_action('updated_user_meta', function($meta_id, $user_id, $meta_key, $_){
    ...
    if ( 'phone' === $meta_key ) update_user_meta($user_id, 'billing_phone', get_user_meta($user_id,'phone',true));
    if ( 'store_name' === $meta_key ) update_user_meta($user_id, 'billing_company', get_user_meta($user_id,'store_name',true));
}, 10, 4);
